...
if iframe_match:
    ...
    if token_match:
        ...
        audio_url = f"https://moonlight.wideiptv.top/RTP1/tracks-a1/index.fmp4.m3u8?token={token}"
        video_url = f"https://moonlight.wideiptv.top/RTP1/tracks-v1/index.fmp4.m3u8?token={token}"
